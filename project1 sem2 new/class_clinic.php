...
require_once 'class_pasien.php';
    ...
    $pasien1->id= '0011' ;
    $pasien1->kode= 'P0011' ;
    $pasien1->name= 'Nani Farida' ;
    $pasien1->tmp_lahir= 'Bogor' ;
    $pasien1->tgl_lahir= '23-02-1970' ;
    $pasien1->email= 'nani@gmail.com' ;
    $pasien1->gender= 'Perempuan' ;

    $bmipasien1 = new BmiPasien();
    $bmipasien1->tgl_periksa= '20-04-2022';
    ...
    $pasien2->id= '0012' ;
    $pasien2->kode= 'P0012' ;
    $pasien2->name= 'Zico Aldebaram' ;
    $pasien2->tmp_lahir= 'Jakarta' ;
    $pasien2->tgl_lahir= '25-02-2000' ;
    $pasien2->email= 'zico@gmail.com' ;
    $pasien2->gender= 'Laki-Laki' ;

    $bmipasien2 = new BmiPasien();
    $bmipasien2->tgl_periksa= '20-04-2022';
